...
import distributedadaptivecep.simulation.SimulationSetup._
...
object SimulationSetup {
  ...
  val publishers = Map(
    ...
    "D" -> actorSystem.actorOf(Props(new EmptyPublisher), "D"),
    "E" -> actorSystem.actorOf(Props(new EmptyPublisher), "E"))
