...
import adaptivecep.data.Queries.DisjunctionQuery
import adaptivecep.graph.nodes.implementation.DisjunctionNodeImpl
...
case class DisjunctionNodeProxy(
  ...
  override def preStart(): Unit = {
    ...
    worker = context.actorOf(Props(DisjunctionNodeImpl(query, publishers, frequencyMonitorFactory,
