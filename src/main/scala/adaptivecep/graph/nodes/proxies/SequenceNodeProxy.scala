...
import adaptivecep.data.Queries.SequenceQuery
import adaptivecep.graph.nodes.implementation.SequenceNodeImpl
...
case class SequenceNodeProxy (
  ...
  override def preStart(): Unit = {
    ...
    worker = context.actorOf(Props(SequenceNodeImpl(query, publishers, frequencyMonitorFactory, latencyMonitorFactory,
