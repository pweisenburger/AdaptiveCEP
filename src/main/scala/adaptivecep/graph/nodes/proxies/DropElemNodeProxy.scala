...
import adaptivecep.data.Queries.DropElemQuery
import adaptivecep.graph.nodes.implementation.DropElemNodeImpl
...
case class DropElemNodeProxy(
 ...
 var worker: ActorRef = null
  ...
  override def preStart(): Unit = {
    ...
    worker = context.actorOf(Props(DropElemNodeImpl(query, publishers, frequencyMonitorFactory, latencyMonitorFactory,
