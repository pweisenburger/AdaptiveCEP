    ...
    if (sender == childNode) {
      event match {
        ...
        case EncEvent1(e1, rule) =>
          ...
          sendEvent("sq", Array(toAnyRef(e1)))
        case EncEvent2(e1, e2, rule) =>
          if (inputRule.isEmpty) inputRule = Some(rule)
          sendEvent("sq", Array(toAnyRef(e1), toAnyRef(e2)))
        case EncEvent3(e1, e2, e3, rule) =>
          if (inputRule.isEmpty) inputRule = Some(rule)
          sendEvent("sq", Array(toAnyRef(e1), toAnyRef(e2), toAnyRef(e3)))
        case EncEvent4(e1, e2, e3, e4, rule) =>
          if (inputRule.isEmpty) inputRule = Some(rule)
          sendEvent("sq", Array(toAnyRef(e1), toAnyRef(e2), toAnyRef(e3), toAnyRef(e4)))
        case EncEvent5(e1, e2, e3, e4, e5, rule) =>
          if (inputRule.isEmpty) inputRule = Some(rule)
          sendEvent("sq", Array(toAnyRef(e1), toAnyRef(e2), toAnyRef(e3), toAnyRef(e4), toAnyRef(e5)))
        case EncEvent6(e1, e2, e3, e4, e5, e6, rule) =>
          if (inputRule.isEmpty) inputRule = Some(rule)
          sendEvent("sq", Array(toAnyRef(e1), toAnyRef(e2), toAnyRef(e3), toAnyRef(e4), toAnyRef(e5), toAnyRef(e6)))
      }
    }
  }
