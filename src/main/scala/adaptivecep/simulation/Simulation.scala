...
import adaptivecep.simulation.Simulation._
import adaptivecep.system.{Host, Operator, System}
...
class Simulation(system: System) {
  ...
  def placeOptimizingLatency(): Unit = {
    ...
    // Map actually extends Function1, and it's apply method is defined intuitively to return the value mapped by the key.
