...
//    (cond, input) match {
//      case (f: (Event1 => Boolean), e: Event1) =>
//        println("Event1")
//        f(e)
//      case (f: (Event2 => Boolean), e: Event2) =>
//        println("Event2")
//        f(e)
//      case (f: (Event3 => Boolean), e: Event3) =>
//        println("Event3")
//        f(e)
//      case (f: (Event4 => Boolean), e: Event4) =>
//        println("Event4")
//        f(e)
//      case (f: (Event5 => Boolean), e: Event5) =>
//        println("Event5")
//        f(e)
//      case (f: (Event6 => Boolean), e: Event6) =>
//        println("Event6")
//        f(e)
//
