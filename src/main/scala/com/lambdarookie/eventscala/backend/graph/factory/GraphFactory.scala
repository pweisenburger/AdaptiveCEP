...
object GraphFactory {
  ...
  def create[A, B, C](system: System,
                      actorSystem: ActorSystem,
                      query: Query3[A, B, C],
                      publishers: Map[String, ActorRef],
                      centralScheduler: CentralScheduler,
  ...
  def create[A, B, C, D](system: System,
                         actorSystem: ActorSystem,
  ...
  def create[A, B, C, D, E](system: System,
                            actorSystem: ActorSystem,
  ...
  def create[A, B, C, D, E, F](system: System,
                               actorSystem: ActorSystem,
