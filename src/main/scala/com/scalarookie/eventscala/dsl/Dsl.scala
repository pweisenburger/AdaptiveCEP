...
object Dsl {
  ...
  case class Query1Helper[A](q: Query1[A]) {
    def keepEventsWith      (                           cond: (A) => Boolean,   requirements: Requirement*): Query1[A] =                KeepEventsWith1 (q, cond,       requirements.toSet)
  ...
  case class Query2Helper[A, B](q: Query2[A, B]) {
    def keepEventsWith   (                        cond: (A, B) => Boolean, requirements: Requirement*): Query2[A, B] =             KeepEventsWith2   (q, cond,       requirements.toSet)
  ...
  case class Query3Helper[A, B, C](q: Query3[A, B, C]) {
    def keepEventsWith (                     cond: (A, B, C) => Boolean, requirements: Requirement*): Query3[A, B, C] =          KeepEventsWith3   (q, cond,       requirements.toSet)
  ...
  case class Query4Helper[A, B, C, D](q: Query4[A, B, C, D]) {
    def keepEventsWith (                  cond: (A, B, C, D) => Boolean, requirements: Requirement*): Query4[A, B, C, D] =       KeepEventsWith4   (q, cond,       requirements.toSet)
  ...
  case class Query5Helper[A, B, C, D, E](q: Query5[A, B, C, D, E]) {
    def keepEventsWith (               cond: (A, B, C, D, E) => Boolean, requirements: Requirement*): Query5[A, B, C, D, E] =    KeepEventsWith5   (q, cond,       requirements.toSet)
  ...
  case class Query6Helper[A, B, C, D, E, F](q: Query6[A, B, C, D, E, F]) {
    def keepEventsWith (cond: (A, B, C, D, E, F) => Boolean, requirements: Requirement*): Query6[A, B, C, D, E, F] = KeepEventsWith6   (q, cond, requirements.toSet)
