...
object Dsl {
  ...
  case class Query1Helper[A](q: Query1[A]) {
    def keepEventsWith      (                           cond: (A) => Boolean,   fr: Option[FrequencyRequirement], lr: Option[LatencyRequirement]): Query1[A] =                KeepEventsWith1 (q, cond, fr, lr)
  ...
  case class Query2Helper[A, B](q: Query2[A, B]) {
    def keepEventsWith   (                        cond: (A, B) => Boolean, fr: Option[FrequencyRequirement], lr: Option[LatencyRequirement]): Query2[A, B] =             KeepEventsWith2   (q, cond, fr, lr)
  ...
  case class Query3Helper[A, B, C](q: Query3[A, B, C]) {
    def keepEventsWith (                     cond: (A, B, C) => Boolean, fr: Option[FrequencyRequirement], lr: Option[LatencyRequirement]): Query3[A, B, C] =          KeepEventsWith3   (q, cond, fr, lr)
  ...
  case class Query4Helper[A, B, C, D](q: Query4[A, B, C, D]) {
    def keepEventsWith (                  cond: (A, B, C, D) => Boolean, fr: Option[FrequencyRequirement], lr: Option[LatencyRequirement]): Query4[A, B, C, D] =       KeepEventsWith4   (q, cond, fr, lr)
  ...
  case class Query5Helper[A, B, C, D, E](q: Query5[A, B, C, D, E]) {
    def keepEventsWith (               cond: (A, B, C, D, E) => Boolean, fr: Option[FrequencyRequirement], lr: Option[LatencyRequirement]): Query5[A, B, C, D, E] =    KeepEventsWith5   (q, cond, fr, lr)
  ...
  case class Query6Helper[A, B, C, D, E, F](q: Query6[A, B, C, D, E, F]) {
    def keepEventsWith (cond: (A, B, C, D, E, F) => Boolean, fr: Option[FrequencyRequirement], lr: Option[LatencyRequirement]): Query6[A, B, C, D, E, F] = KeepEventsWith6   (q, cond, fr, lr)
