...
class QoSUnitTests extends FunSuiteLike {
  test("QoSUnits - TimeSpan") {
    assert(10.ms < 10.mics)
    assert(10.ms < 10.sec)
    assert(10.mics < 10.sec)
    assert(10.ms < 11.ms)
    assert(10.mics < 11.mics)
    assert(10.sec < 11.sec)
    assert(10.mics > 10.ms)
    assert(10.sec > 10.ms)
    assert(10.sec > 10.mics)
    assert(11.ms > 10.ms)
    assert(11.mics > 10.mics)
    ...
    assert(10.sec <= 11.sec)
    assert(10.ms <= 10.ms)
    assert(10.mics <= 10.mics)
    assert(10.sec <= 10.sec)
    assert(10.sec - 9.sec == 1.sec)
    assert(10.mics - 9.mics == 1.mics)
